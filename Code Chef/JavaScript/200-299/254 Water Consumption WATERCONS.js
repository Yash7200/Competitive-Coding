//Problem Simplification:
    //Doctor advised Chef drink at least 2000 ml water daily check if he drinks it or not.
...
//Logic to solve Problem:
    ...
    //In function containing core logic, use ternary if-else to check if he drinks at least 2000 ml water & print the message.
...
const isAtLeastWaterDrank = (waterLevel) => {
    (waterLevel >= 2000)
        ? console.log("YES")
        : console.log("NO");
}
